...
namespace Core.UnitTests.SimulatedAnnealing.Optimizers
{
    [TestFixture]
    public class BobyqaTests
    {
        ...
        public void FindMinimum_IntermedRosenbrock_ReturnsValidMinimum()
        {
            ...
            Assert.AreEqual(-1.0, summary.X[0], Tolerance);
            Assert.AreEqual(1.0, summary.X[1], Tolerance);
        }
        ...
        public void FindMinimum_HS04_ReturnsValidMinimum()
        {
            ...
            Assert.AreEqual(1.0, result.X[0], Tolerance);
            Assert.AreEqual(0.0, result.X[1], Tolerance);
        }
        ...
        public void FindMinimum_HS05_ReturnsValidMinimum()
        {
            ...
            Assert.AreEqual(0.5 - Math.PI / 3.0, result.X[0], Tolerance);
            Assert.AreEqual(-0.5 - Math.PI / 3.0, result.X[1], Tolerance);
        }
        ...
        [TestCase(13, 78), Microsoft.VisualStudio.TestTools.UnitTesting.Ignore]
        ...
        public void FindMinimum_LogOutput_OutputNonEmpty()
        {
            ...
            using (var logger = new StringWriter())
            {
                ...
                Assert.AreNotSame(logger.ToString().Length, 0);
            }
        }
