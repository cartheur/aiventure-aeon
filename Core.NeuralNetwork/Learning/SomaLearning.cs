using System;
using Core.NeuralNetwork.Layers;
using Core.NeuralNetwork.Networks;
using Core.NeuralNetwork.Neurons;

namespace Core.NeuralNetwork.Learning
{
    /// <summary>
	...
	/// 
	public class SomaLearning : IUnsupervisedLearning
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SomaLearning"/> class
        /// </summary>
        /// 
        ...
        /// 
        public SomaLearning(DistanceNetwork network)
        {
        ...
        /// </remarks> 
        ///
        public SomaLearning(DistanceNetwork network, int width, int height)
        {
            // check network size
