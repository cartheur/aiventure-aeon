...
namespace Animals.Core.Utililties
{
    ...
    public class Node
    {
        ...
        /// <summary>
        /// The source for the category that defines the template
        /// </summary>
        ...
        public void AddCategory(string path, string template, string filename)
        {
            ...
            {
                throw new XmlException("The category with a pattern: " + path + " found in file: " + filename + " has an empty template tag.");
            }
        ...
        /// <param name="wildcard">The contents of the user input absorbed by the  wildcards "_" and "*"</param>
        ...
        public string Evaluate(string path, SubQuery query, Request request, MatchState matchstate, StringBuilder wildcard)
        {
            ...
            {
                request.ThisAeon.WriteToLog("Request timeout. User: " + request.ThisUser.UserId + " raw input: \"" + request.RawInput + "\"");
            ...
            // wildcard. "_" comes first in precedence in the  alphabet
            ...
            //  files have been set up to include a "* <that> * <topic> *" catch-all this
