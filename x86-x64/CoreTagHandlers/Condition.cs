...
namespace Animals.Core.CoreTagHandlers
{
    ...
    /// ---------------
    /// 
    /// The blockCondition type of condition has a required attribute "name", which specifies an  
    ...
    /// </summary>
    public class Condition : CoreTagHandler
    {
        /// <summary>
        ...
        public Condition(Aeon thisAeon,
                        User thisUser,
                        SubQuery query,
                        Request thisRequest,
                        Result thisResult,
        ...
        protected override string ProcessChange()
        {
            ...
            {
                // ToDo: Heuristically work out the type of condition being processed.
