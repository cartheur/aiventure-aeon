...
local painterFunctions = {
   ...
   "currentmatrix", "currentmode", "currentpath", "currentpen",
   "currentpoint", "curveto", "depth", "device", "eoclip", "eofill", "fill",
   "gbegin", "gend", "grestore", "gsave", "height", "image", "initclip",
   "initgraphics", "initmatrix", "lineto", "moveto", "newpath", "painter",
   "pixmap", "printer", "rcurveto", "rect", "rectangle", "refresh", "rlineto",
   "rmoveto", "rotate", "scale", "setangleunit", "setbackground", "setbrush",
   "setbrushorigin", "setclip", "setfont", "sethints",
   "setmatrix", "setmode", "setpath", "setpen", "setpoint",
